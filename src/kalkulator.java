...
public class kalkulator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnPersen.setBackground(new java.awt.Color(204, 204, 255));
        btnPersen.setText("%");
        ...
        btnPlusMin.setBackground(new java.awt.Color(204, 204, 255));
        btnPlusMin.setText("+/-");
        ...
        btnAngka8.setBackground(new java.awt.Color(204, 204, 255));
        btnAngka8.setText("8");
